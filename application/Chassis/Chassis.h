...
#define CHASSIS_3508_PID_KI     1.0f//1.0f
#define CHASSIS_3508_PID_KD     0.0f
#define CHASSIS_3508_PID_MAX_OUT 16384.0f
#define CHASSIS_3508_PID_MAX_IOUT 1000.0f
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 0.15f//0.1
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.05f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 2.0f//2.0
