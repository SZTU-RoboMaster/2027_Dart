...
#include "../Communication/can_receive.h"
#include "user_lib.h"
#include "../A_Dart/protocol_shaob.h"
#include "filter.h"
...
#define GIMBAL_YAW_OFFSET_ECD 5120
...
//普通云台pid常量
#define GIMBAL_YAW_ANGLE_PID_KP     50.f//15f
#define GIMBAL_YAW_ANGLE_PID_KI     0.05f//0.005f
#define GIMBAL_YAW_ANGLE_PID_KD     800.0f//300.f
#define GIMBAL_YAW_ANGLE_MAX_OUT    10000.f
#define GIMBAL_YAW_ANGLE_MAX_IOUT   100.f//60

#define GIMBAL_YAW_SPEED_PID_KP     200.f//180
#define GIMBAL_YAW_SPEED_PID_KI     20.5f//50.0f
#define GIMBAL_YAW_SPEED_PID_KD     80.0f//
...
//#define GIMBAL_PITCH_ANGLE_PID_KD   500.f//280
//#define GIMBAL_PITCH_ANGLE_MAX_OUT  400.f
//#define GIMBAL_PITCH_ANGLE_MAX_IOUT 40.f
//
//#define GIMBAL_PITCH_SPEED_PID_KP   80.f//300
...
//#define GIMBAL_PITCH_ANGLE_PID_KD   500.f
//#define GIMBAL_PITCH_ANGLE_MAX_OUT  500.f
//#define GIMBAL_PITCH_ANGLE_MAX_IOUT 60.f
//
//#define GIMBAL_PITCH_SPEED_PID_KP   100.f
//#define GIMBAL_PITCH_SPEED_PID_KI   3.5f
//#define GIMBAL_PITCH_SPEED_PID_KD   100.f
//#define GIMBAL_PITCH_SPEED_MAX_OUT  30000.f
//#define GIMBAL_PITCH_SPEED_MAX_IOUT 9000.f
...
#define GIMBAL_YAW_ANGLE_PID_KP_AUTO     50.f//15f
#define GIMBAL_YAW_ANGLE_PID_KI_AUTO     0.05f//0.005f
#define GIMBAL_YAW_ANGLE_PID_KD_AUTO     800.0f//300.f
...
#define GIMBAL_YAW_SPEED_PID_KI_AUTO     20.5f//50.0f
#define GIMBAL_YAW_SPEED_PID_KD_AUTO     80.0f//
...
#define GIMBAL_PITCH_ANGLE_PID_KD_AUTO   500.f
